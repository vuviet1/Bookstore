...
<!--                                <a href="../../admin/login.html"><i class="fa fa-user"></i>Đăng nhập</a>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        <a href="./index.php"><img src="img/logo1.png" height="150px" width="200px" alt=""></a>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="col-lg-6">-->
...
<!--                            <li><a href="../shop_grid/shop-grid.html">Shop</a></li>-->
<!--                            <li><a href="#">Trang</a>-->
<!--                                <ul class="header__menu__dropdown">-->
<!--                                    <li><a href="../shop_details/shop-details.html">Chi tiết sản phẩm</a></li>-->
<!--                                    <li><a href="../shopping_cart/shoping-cart.html">Giỏ hàng</a></li>-->
<!--                                    <li><a href="../check_out/checkout.html">Kiểm tra</a></li>-->
<!--                                </ul>-->
<!--                            </li>-->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__right__auth">
                            <a href="view/admin/login.html"><i class="fa fa-user"></i>Đăng nhập</a>
                        </div>
                    </div>
                </div>
            </div>
