...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item active">
        <a href="index.php?controller=" class="menu-link">
    ...
    <!-- Layouts -->
    <li class="menu-item">
        <a href="index.php?controller=tk" class="menu-link">
            <i class="menu-icon tf-icons bx bx-user-circle"></i>
            <div data-i18n="Layouts">Thiết lâp tài khoản</div>
        </a>
    </li>
    ...
    <li class="menu-item">
        <a href="index.php?controller=nv" class="menu-link">
            <i class="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="Account Settings">Nhân viên</div>
        </a>
    </li>
    <li class="menu-item">
        <a href="index.php?controller=kh" class="menu-link">
    ...
    <li class="menu-item">
        <a href="index.php?controller=hoadon" class="menu-link">
            <i class="menu-icon tf-icons bx bx-receipt"></i>
            <div data-i18n="Account Settings">Hóa đơn</div>
        </a>
    </li>
    <li class="menu-item">
        <a href="index.php?controller=sp" class="menu-link">
    ...
    <li class="menu-item">
        <a href="index.php?controller=theloai" class="menu-link">
    ...
    <li class="menu-item">
        <a href="index.php?controller=ptvc" class="menu-link">
            ...
            <div data-i18n="Account Settings">Phương thức vân chuyển</div>
        </a>
    </li>
</ul>
</aside>
